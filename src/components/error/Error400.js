...
const Error400 = () => {
  return (
    <main className="grid min-h-screen place-items-center bg-gray-900 px-6 py-0 sm:py-32 lg:px-8">
      <div className="text-center animate-fade-in-up">
        {/* Código de error */}
        <p className="text-7xl font-extrabold text-blue-500 drop-shadow-md">400</p>
